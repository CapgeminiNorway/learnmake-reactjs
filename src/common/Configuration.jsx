...
const Configuration = ({ theme, locale, changeTheme, changeLocale, translate }) => (
    <Card>
        ...
        <CardText>
            ...
            <RaisedButton style={styles.button} label="English" primary={locale === 'en'} onClick={() => changeLocale('en')} />
            <RaisedButton style={styles.button} label="Norsk" primary={locale === 'nb'} onClick={() => changeLocale('nb')} />
        </CardText>
    </Card>
);
